...
- [ ] Initialize Python virtual environment (`venv`), Django project (`counterpoint`), and DRF app (`api`).
- [ ] Configure `django-cors-headers`, environment variables (`python-dotenv`), and `requirements.txt`.
- [ ] Setup initial Vite frontend structure and base CSS design tokens.
